...
This will come in handy later on, when we want to extract rows from data frames by different conditions, so let's take a closer look in [Logical comparisons](logical.qmd)
