...
# Getting an overview
To take a look at these data structures, we can use different commands. 
One of the most important ones might be `View()`, which will open the data set excel-style in a new window:
