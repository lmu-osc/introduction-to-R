...
![](./pictures/app.png){width="19"}[^packages-1] Then, we have to load them in each session where we want to use them (like tipping on the app icon): `library(packagename)`.
