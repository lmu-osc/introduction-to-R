...
![](./pictures/app.png){width="19"}[^packages-2] Then, we have to load them in each session where we want to use them (like tapping on the app icon): `library(packagename)`.
