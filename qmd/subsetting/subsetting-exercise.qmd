...
aliases: [subsetting_exercise.html]
---
...
Correct the following code, so only the first 10 rows and columns 4 to 6 are extracted:
...
```{r}
characters[
  characters$uni_name == "Game of Thrones" & characters$notability > 90,
]
```
