...
We can also combine multiple logical vectors using [`&` ("and") and `|` ("or")](https://lmu-osc.github.io/introduction-to-R/qmd/basics/basics.html#or-and-and). For example, we might want to look at all german athletes before the year 2000:
...
```{r}
athletes_3 <- athletes[
  (athletes$Sport == "Judo") & (athletes$Weight > 100 | athletes$Weight < 50),
]
head(athletes_3)
```
