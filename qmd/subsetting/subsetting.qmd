...
For the rest of the workshop, we will use the data set `winners` from the package [LondonMarathon](https://github.com/nrennie/LondonMarathon). We have already loaded the data set in the [exercises of the last chapter](../load_data/load_data_exercise.qmd).
