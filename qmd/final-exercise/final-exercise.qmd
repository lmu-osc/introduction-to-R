...
If you are a R beginner and followed the workshop, you can do this last exercise **at the end** to test your knowledge. It will be a bit harder than the other workshop exercises to challenge you one last time and encourage you to think about concepts you might want to revisit, so don't worry if some exercises feel a bit harder, we haven't talked about everything yet.  
...
::: callout-tip
Throughout this script I will use a mixture of [`tidyverse`](../basics/tidyverse.qmd) and `Base R` code. Feel free to use the syntax you are comfortable with.
:::
