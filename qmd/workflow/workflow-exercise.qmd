...
aliases: [workflow_exercise.html]
---
...
Go to `File` - `New File` - `R Script`. Save it into your folder by going to `File` - `Save` and selecting your folder. 
:::
