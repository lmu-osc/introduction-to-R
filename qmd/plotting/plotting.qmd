...
Now, let's take a closer look at how `ggplot2` works. We already had a quick glimpse at it: Plots are build from different layers to create complex outputs. There are endless possibilities for different plot types, \[look\] here(https://r-graph-gallery.com/) for some inspiration and code.
