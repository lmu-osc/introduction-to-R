...
This exercise comes back to most topics presented in this workshop. If you a total R beginner and followed the workshop, you can do this last exercise in the end to again test your knowledge. If you already have some R experience, you can do this exercise before the rest of the workshop and use it to identify weak points to follow up on. 
...
```{r}
tuesdata <- tidytuesdayR::tt_load('2020-05-19')$vb_matches
