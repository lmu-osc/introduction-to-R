...
## Hint
Right-click on the respective data set found under this link, select 'save as' and then choose a folder on your notebook where to save it. We have talked about where that optimally should be in [Workflow: Exercises](../getting_started/worflow_exercise.qmd).
:::
