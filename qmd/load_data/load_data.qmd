...
For the rest of the workshop, we will use the data set `winners` from the package [LondonMarathon](https://github.com/nrennie/LondonMarathon). Let's load it into R: 
