...
Let's load our Olympic athletes data set into R. When we look into our [table](#Data-types) we can see we have to use the `readRDS()` function for loading `.rds` files:
