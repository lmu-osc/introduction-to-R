...
1.  Click on `Sign Up` to create an account (it's free) and login.
1.  On the upper right, click on `New Project`. This will create a new RStudio project, which you can follow this workshop with the same way as if you had installed R on your notebook. 
