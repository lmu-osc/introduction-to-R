...
Here, the column names are printed on the left side, followed by the [type]() of the column and then the first few values of each column. We can also see in the first row that this object is a data frame with `271116` rows and `15` columns.
