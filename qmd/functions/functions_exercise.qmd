...
Actually, this function calculates the Body Mass Index (BMI): $\frac{weight(kg)}{height(m)^2}$.
However, it doesn't return a numeric value, but just prints the result of the calculation along with some text.
