...
On the left we can see the columns of this data.frame, named `Date`, `Year`, `Applicants` etc ...
Further on the right we see the first values in each column, for example `1981`, `1982` etc ...


## Data wrangling
Now, lets do something fun with this data. We want to answer the question if people have gotten faster at running marathons over that last 40 years. We will use a 
Some sort of regression using the times or f
