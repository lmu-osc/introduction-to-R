...
[Data is loaded](\load_data.qmd) into R so you can work with it. Let's do just that.
First, you need to download the file "" from 

```{r}

```

The data comes from [LondonMarathon](https://github.com/nrennie/LondonMarathon) package.
