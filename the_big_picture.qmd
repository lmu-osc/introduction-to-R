...
For this chapter, we are going to use the data set `babynames`, which we can find on the `tidytuesday` site:
...
(Yes, we can read in `.csv` data simply by using an URL if provided.)
