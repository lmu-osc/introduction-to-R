...
Each section is divided into a theory part and some exercises. Most of these exercises will use the `characters` data set, more on that in the [next chapter](/qmd/getting_started/exercise_overview.qmd).

::: callout-warning
## Software installation

Please [install the necessary software](qmd/setup/setup.qmd) **before the workshop**. Of course, feel free to [ask questions by opening a new issue](https://github.com/nickhaf/r_tutorial/issues) if you run into problems on the way.
:::
