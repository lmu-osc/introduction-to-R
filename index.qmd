...
This workshop will teach you the basics of R. It's modular structure is meant to support different levels of R expertise and interests: already know the basics and want to learn how to [plot](plotting.qmd)? Want to freshen up your R skills and look at specific topics? Or are you new to scientific programming with R and want to follow the course structure?
...
Each section is divided into a theory part and some exercises. Most of these exercises will use the \`characters\` data set, more on that in the [next chapter](../setup/setup_exercises.qmd).
